...
export const siteConfig = {
  apiBaseUrl: cleanEnv(process.env.NEXT_PUBLIC_API_BASE_URL) || 'https://web-production-581b4.up.railway.app/headless',
  typo3BaseUrl: cleanEnv(process.env.NEXT_PUBLIC_TYPO3_BASE_URL) || 'https://web-production-581b4.up.railway.app/headless',
